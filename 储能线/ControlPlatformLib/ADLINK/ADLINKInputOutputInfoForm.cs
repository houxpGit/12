...
{
    public partial class ADLINKInputOutputInfoForm : Form
    {
        ADLINKInputOutputInfo hardInfo;
        public ADLINKInputOutputInfoForm(ADLINKInputOutputInfo info)
        {
            InitializeComponent();
            hardInfo = info;
        }

        private void ADLINKInputOutputInfoForm_Load(object sender, EventArgs e)
        {
